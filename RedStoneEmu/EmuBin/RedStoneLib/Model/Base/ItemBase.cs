...
namespace RedStoneLib.Model.Base
{
    ...
    public class ItemBase
    {
        ...
        /// 全てのアイテムを読み込む
        /// </summary>
        public static void Load(Stream itemStream)
        {
            using (PacketReader br = new PacketReader(itemStream))
            {
                //復号化キーのセット
        ...
        /// 攻撃速度（武器のみ）
        /// </summary>
        public ushort AttackSpeed => m_value.AttackSpeed;
