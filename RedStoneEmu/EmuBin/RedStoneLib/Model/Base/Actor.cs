...
namespace RedStoneLib.Model.Base
{
    ...
    public abstract class Actor
    {
        ...
        /// </summary>
        [MinimumActorInfo(1)]
        private ushort QuestID { get; set; } = 0xFFFF;
        ...
        protected Actor(MapActorSingle single, MapActorGroup group, ushort charID)
            : this()
        {
        ...
        /// レベルとパラメーターをセット
        /// </summary>
        protected void SetStatusByLevel(ushort level)
        {
            //レベル代入
            Level = level;
        ...
        public void UseSkill(SendPacketDelegate sendPacket, Actor target, Skill skill, int slv)
        {
            skill.TryGetPacketToUseEnemy(out var packet, out double totalDamage, slv, this, target);
            sendPacket(packet);
        }
        ...
        public void DecreaseHP(SendPacketDelegate sendPacket, double totalDamage)
        {
