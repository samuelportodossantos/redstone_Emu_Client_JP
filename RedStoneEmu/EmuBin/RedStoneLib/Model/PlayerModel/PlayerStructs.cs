...
namespace RedStoneLib.Model
{
    public partial class Player
    {
        ...
        public class ItemCollection : IEnumerable<Item>
        {
            ...
            /// 効果変更イベント
            /// </summary>
            public event ChangeEffectDelegate OnChangeEffect
            {
                add
                {
            ...
            /// <returns></returns>
            public bool AutoInject(Item injectItem)
            {
                if (EmptySpaceNumber <= 0) return false;
            ...
            /// アイテムの残りスペース
            /// </summary>
            public int EmptySpaceNumber
            {
                get => Items.Count(t => t.IsEmpty);
            }
