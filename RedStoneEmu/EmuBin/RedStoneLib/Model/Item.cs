...
namespace RedStoneLib.Model
{
    public sealed class Item : IComparable
    {
        ...
        public uint CheckSum
        {
            ...
            {
                if (IsEmpty) return 0;
                int result = UniqueID + ItemIndex + Number + Endurance;
                ...
                {
                    result += op.ItemOPIndex + op.Value1 + op.Value2;
                }
                result += unk_bool1 ? 1 : 0;
                result += unk_bool2 ? 1 : 0;
                result += unk_bool3 ? 1 : 0;
                result += (int)StackableFlag;
                result += unk_flag1 + unk_flag2 + unk_flag3 + unk_flag4 + unk_flag5;
                return (uint)result;
            }
        }
