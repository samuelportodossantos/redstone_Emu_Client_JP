...
namespace RedStoneLib.Packets.RSPacket.GameLogin
{
    ...
    public class ResultJoinGamePacket : Packet
    {
        ...
        /// Gvフィールドフラグ
        /// </summary>
        [BitField(0, 0x01, type: typeof(byte))]
        private bool IsGuildBattleField { get; set; } = false;

        /// <summary>
        /// OXクイズフィールドフラグ
        /// </summary>
        [BitField(1, 0x01, type: typeof(byte))]
        private bool IsOXQuizField { get; set; } = false;

        /// <summary>
        /// 村フラグ
        /// </summary>
        [BitField(2, 0x01, type: typeof(byte))]
        private bool IsVillage { get; set; }

        /// <summary>
        /// ミニマップレベル
        /// </summary>
        [BitField(3, 0x03)]
        private byte MinimapDisplayLevel { get; set; }*/
        ...
        /// 最大体力増加ボーナスが5％減少します。
        /// </summary>
        [BitField(1, 0x03, type:typeof(byte))]
        private byte SiegeWarfareState { get; set; } = 0;
        ...
        /// </summary>
        [BitField(9, 0x01)]
        private byte Unknown3 { get; set; } = 0;
