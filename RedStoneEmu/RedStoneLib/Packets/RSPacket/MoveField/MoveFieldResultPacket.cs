...
namespace RedStoneLib.Packets.RSPacket.MoveField
{
    ...
    public class MoveFieldResultPacket : Packet
    {
        ...
        /// 移動先IP
        /// </summary>
        string MoveToIPAddress;

        /// <summary>
        /// 成功
        /// </summary>
        /// <param name="fileName"></param>
        public MoveFieldResultPacket(string fileName, string moveToIPAddress)
        {
            FileName = fileName;
            Result = MoveFieldResult.Success;
            MoveToIPAddress = moveToIPAddress;
        }
        ...
        public override byte[] Build()
        {
            ...
            writer.WriteSjis(MoveToIPAddress, 0x10);//接続先ＩＰ
