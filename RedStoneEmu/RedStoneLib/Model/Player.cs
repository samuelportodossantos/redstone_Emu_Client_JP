...
namespace RedStoneLib.Model
{
    ...
    public partial class Player : Actor
    {
        ...
        /// 職業 +0x18, +0xD4
        /// </summary>
        [SimpleActorInfo(13, 0x0A, type: typeof(ushort))]
        [VerySimpleActorInfo(14, 0x0A, type: typeof(byte))]
        ...
        /// GMLevel +0x7F2
        /// </summary>
        [SimpleActorInfo(15, 0x03)]
        [VerySimpleActorInfo(11, 0x03)]
        public int GMLevel
        {
        ...
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(4, 0x02, type: typeof(byte))]
        [VerySimpleActorInfo(12, 0x02, type: typeof(byte))]
        public SummonerRidingType RidingType { get; set; }

        /// <summary>
        /// 死亡フラグ +0xC4=0
        /// </summary>
        [NotMapped]
        [VerySimpleActorInfo(13, 0x01, type: typeof(byte))]
        ...
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(16, 0x03, type: typeof(byte))]
        [VerySimpleActorInfo(1, 0x03, type: typeof(byte))]
        ...
        /// </summary>
        [NotMapped]
        public override ushort MoveSpeed { get; set; }

        /// <summary>
        /// キャラID
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(11, 0x0B)]
        [VerySimpleActorInfo(9, 0x0B)]
        ...
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(3, 0x02)]
        [VerySimpleActorInfo(7, 0x02)]
        public byte CanAttack { get; private set; } = 0x00;
        ...
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(14, 0x05)]
        [VerySimpleActorInfo(15, 0x04)]
        ...
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(17, 0x05)]
        [VerySimpleActorInfo(10, 0x05)]
        ...
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(19, 0x04)]
        [VerySimpleActorInfo(16, 0x04)]
        ...
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(20, 0x01, type: typeof(byte))]
        [VerySimpleActorInfo(8, 0x04, type: typeof(byte))]
        ...
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(22, 0x07, 0x03)]
        [VerySimpleActorInfo(17, 0x03)]
        ...
        [VerySimpleActorInfo(18, 0x05)]
        public short MiniPet1 { get; set; }

        /// <summary>
        /// ミニペット2 +0xE4
        /// vsa: +junk size:11
        /// </summary>
        [SimpleActorInfo(25, 0x05)]
        [VerySimpleActorInfo(19, 0x10, 0x1F)]
        public short MiniPet2 { get; set; }

        /// <summary>
        /// 転生回数 +0x13E
        /// </summary>
        [SimpleActorInfo(26, 0x04)]
        ...
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(27, 0x06, 0x01, typeof(byte))]
        ...
        [VerySimpleActorInfo(22, type: typeof(uint))]
        ...
        [VerySimpleActorInfo(23, type: typeof(uint))]
        ...
        [VerySimpleActorInfo(24, type: typeof(uint))]
        ...
        [VerySimpleActorInfo(25, type: typeof(uint))]
        ...
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(34, type: typeof(uint))]
        [VerySimpleActorInfo(26, type: typeof(uint))]
        ...
        /// </summary>
        [NotMapped]
        [SimpleActorInfo(35, type: typeof(ushort))]
        [VerySimpleActorInfo(27, type: typeof(uint))]
        ...
        /// </summary>
        [NotMapped]
        public Dictionary<int, ProgressQuest> ProgressQuests { get; set; } 
            = new Dictionary<int, ProgressQuest>();

        /// <summary>
        /// 終了したクエスト
        /// </summary>
        [NotMapped]
        public List<int> ClosedQuests { get; set; } 
            = new List<int>();
        ...
        /// </summary>
        [NotMapped]
        public Dictionary<byte, byte> Titles { get; set; } 
        ...
        /// </summary>
        [NotMapped]
        public override Dictionary<ushort, Skill> Skills
            => PlayerSkills.ToDictionary(t => t.Index, t => Skill.AllSkills[t.Index]);

        /// <summary>
        /// 取引用ID
        /// </summary>
        [NotMapped]
        public int? TradeID { get; set; } = null;

        /// <summary>
        /// 銀行用セッションID
        /// </summary>
        [NotMapped]
        public ushort? BankSessionID { get; set; } = null;
        ...
        /// <returns></returns>
        public override double GetAttackSpeedWaitTime(Skill skill, int skillLevel)
        {
            //攻撃速度+(%)
            double atkSpeedRate = skill.AttackSpeed[skillLevel] + Effect.AbilityRate.AttackSpeed + Buff.AttackSpeed;
            //フレーム
            double frame = Math.Floor(Math.Floor(16.0 * EquipmentItems.Weapon.Base.AttackSpeed) * (100.0 / (100.0 + atkSpeedRate)));
            ...
            foreach (ChangeStatusInfo info in ((IEnumerable<ChangeStatusInfo>)Enum.GetValues(typeof(ChangeStatusInfo))).Where(t => infos.HasFlag(t)))
            {
                switch (info)
                {
                    case ChangeStatusInfo.Status://ステ変更
                        if (peIndex.HasValue)
                        {
                            foreach (ActorStatusType index in ((IEnumerable<ActorStatusType>)Enum.GetValues(typeof(ActorStatusType))).Where(t => ((ActorStatusType)peIndex).HasFlag(t)))
                            {
        ...
        => new PlayerInfo
        {
            ...
            Titles = Enumerable.Range(0, 20).Select(t=> {
                if (Titles.Count <= t) return (ushort)0;
                else return (ushort)((Titles.Keys.ToArray()[t] << 0x08) | (Titles.Values.ToArray()[t] & 0xFF));
            }).ToArray(),
            Quests = Enumerable.Range(0, 6).Select(t=>ProgressQuests.TryGetValue(t, out var quest)?quest.QuestInfo:(uint)0).ToArray(),
        };
